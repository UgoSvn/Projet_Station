...
<!-- Google Fonts -->
<link
	href="https://fonts.googleapis.com/css?family=Montserrat|Open+Sans+Condensed:300&display=swap"
	rel="stylesheet">

<!-- Font awesome -->
<script src="https://kit.fontawesome.com/8fc4291567.js"
	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-12 col-md-12 navbare">
				...
				<div class="my-navebar">
					<nav
						class="my-navbar navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
						<div class="container">
							...
							<div class="collapse navbar-collapse" id="navbarSupportedContent">
								<ul class="navbar-nav ml-auto">
									...
									<li class="nav-item"><a class="nav-link"
										href="ApplyMoreFilter.jsp">Apply more filters</a></li>
		...
		<div class="row">
			<div class="col-md-12 titre">
				<br /> <br /> <br /> <br /> <br /> <br />
				<h1>FIND THE NEAREST / GAZ STATION</h1>
			</div>
		</div>

		<div class="row">
			<div class="col-12 col-md-1 nothing"></div>
			<!-- Colonne 1 -->
			<div class="col-12 col-md-4 description d-flex align-items-center">
				<h2>
					<br>Don't waste your time anymore and try our solution to find
					the nearest most efficient gas station in a single click. Fast and
					100% reliable, you can drive safely alll around the country without
					thinking of where to find an opened and well equipped gas station.
					Try it now and you'll never regret.
				</h2>
			</div>
			<div class="col-12 col-md-1 nothing"></div>
			<!-- Colonne 2 -->
			<div class="col-12 col-md-6 try">
				<h3>
					<br> <br>TRY IT OUT NOW
				</h3>
				<center>
					<img src="css/images/arrow.png" alt="Fleche" widht="50" />
				</center>
			</div>
		...
		<div class="row">
			...
			<div class="col-12 col-md-6 test d-flex align-items-center">
				<h2 style="padding-left: 50px; padding-right: 50px;">...</h2>
			</div>
		...
		<footer class="container-fluid">
			<div class="row justify-content-around align-items-center">
				<div class="col-12 col-md-4 text-center">
					...
					</a> <a href="https://www.instagram.com/esigelec_officiel/?hl=fr"
						target="_blank"> <i class="fab fa-instagram"></i>
					</a> <a href="https://www.youtube.com/user/ESIGELECIRSEEM"
